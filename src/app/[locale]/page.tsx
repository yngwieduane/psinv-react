...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <div className="my-10 bg-white min-h-[400px] dark:bg-neutral-900">
        <ListPropertyForm />
      </div>
      <div className="my-10 bg-gray-50 dark:bg-neutral-900">
        <WhyPSI />
      </div>
      ...
      <div className="bg-gray-50 px-4 dark:bg-neutral-900">
        ...
        <div className="relative max-w-(--breakpoint-xl) mx-auto py-10 px-5 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 text-center md:hidden">
              <h4 className={`text-primary font-bold md:text-6xl text-4xl dark:text-white ${Audrey.className}`}><span className="data-count" data-count="10"> 0 </span></h4>
              <p className={`md:text-lg text-sm font-medium ${montserrat.className} dark:text-white`}>{t("aboutCounter.locationWorldwide")}</p>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full py-10 text-gray-500 text-center" dir={isRTL ? "rtl" : "ltr"}>
        <div className="container mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-12 dark:text-white">{t_awards("desc")}</p>
        </div>
