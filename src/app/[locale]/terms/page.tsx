  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-4 pb-10 pt-40">
        <h1 className="text-xl md:text-2xl text-left mb-6 text-[#00194A] dark:text-white">
          Terms & Conditions
        </h1>
        <div className={`max-w-5xl mx-auto px-0 py-5 text-gray-800 dark:text-gray-300`}>
          <div
            className="px-6 py-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
          >
            <h2 className="text-xl mb-5 text-[#111954] dark:text-white">
              Introduction
            </h2>
            ...
            <h2 className="text-xl mb-5 text-[#111954] dark:text-white">Modifications and additions</h2>
            ...
            <h2 className="text-xl mb-5 text-[#111954] dark:text-white">Copy Rights</h2>
            <ul className="list-none pl-8 space-y-2">
            ...
            <h2 className="text-xl mb-5 text-[#111954] dark:text-white">Disclaimer</h2>
            <ul className="list-none pl-8 space-y-2">
            ...
            <h2 className="text-xl mb-5 text-[#111954] dark:text-white">Jurisdiction</h2>
