// src/app/[locale]/area-guide/[slug]/page.tsx
...
export async function generateMetadata({ params }: Props) {
    ...
    if (slug === "abu-dhabi") return { title: "Abu Dhabi Area Guide" };
    if (slug === "dubai") return { title: "Dubai Area Guide" };

    // ✅ Match the signature used in your articles/[slug]/page.tsx (params is Promise)
...
async function CityListing({
  city,
  locale,
}: {
  city: string;   // ✅ was: "Abu Dhabi" | "Dubai"
  locale: string;
}) {
                ...
                {cityArticles.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {cityArticles.map((article) => (
                            ...
                            >
                                <Link href={`/articles/area-guide/${article.slug}`} className="block h-full flex flex-col">
