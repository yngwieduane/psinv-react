                    ...
                    <SwiperSlide key={index} className="pb-20">
                        <div className="row mx-0 h-100 px-0 text-center mb-5">
                            <div className="container mx-auto px-4 md:px-8 max-w-4xl">
                                <div
                                    className="w-40 h-40 mx-auto mb-10 rounded-full overflow-hidden lazy border-4 border-white shadow-2xl ring-1 ring-gray-100">
                                ...
                                <div className={`relative ${outfit.className} mb-10`}>
                                    ...
                                    <p className={ `text-gray-600 font-light text-xl mb-10 leading-relaxed px-8 ${opensans.className}`}>
                                    {slide.text} </p>
                                    <span className="text-6xl text-gray-200 font-serif absolute -bottom-16 right-0 opacity-50 rotate-180">"</span>
                                </div>
                                <h3 className="font-bold text-2xl text-primary tracking-wide uppercase">{slide.name}</h3>
                                <p className={`text-gray-800 text-3xl mt-2 ${greatVibes.className}`}>{slide.designation}</p>
                            </div>
                        </div>
                    </SwiperSlide>
                ))}                
