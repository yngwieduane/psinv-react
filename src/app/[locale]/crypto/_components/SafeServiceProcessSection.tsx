                        ...
                        <div className="relative w-full h-full flex items-center justify-center">
                            ...
                            <div className="relative w-full h-full max-h-[400px] flex items-center justify-center">
                                <Image
                                    ...
                                    alt="safe-service" title="safe-service"
                                    width={200}
                                    height={200}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="mb-4 md:mb-6">
                                        <Image src={card.icon} alt="crypto safe service" title="crypto safe service" width={40} height={40} className="md:w-[50px] md:h-[50px]" />
                                    </div>
