        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden bg-black/20" onClick={onCloseModal}>
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16" >
              ...
              >
                <div className="flex h-full flex-col overflow-y-scroll bg-white py-0 shadow-xl pl-7 pr-11 pt-5 pb-3 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-700/50">
