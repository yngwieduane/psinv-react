        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-20" dir={isRtl ? "rtl" : "ltr"}>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white font-light">
              ...
              <li><Link target="_blank" href="https://www.psi-consultants.de" title={t('footer_links_germany')} className="hover:text-gray-400 hover:pl-2 rtl:hover:pr-2 transition-all">{t('footer_links_germany')}</Link></li>
            </ul>
          </div>
