...
const CompareFloatingButton = () => {
    ...
    return (
        <Link href="/compare" className="fixed bottom-6 left-6 z-50 animate-bounce hover:animate-none">
            <div className="bg-primary text-black p-4 rounded-full shadow-2xl flex items-center gap-2 hover:bg-primary/90 transition-colors border-2 border-white/20 backdrop-blur-sm">
