...
return (
    <div className='group relative'>
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2 z-10 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <button 
            onClick={(e) => { e.stopPropagation(); toggleFavorite({ id: props.data["propertyID"], type: 'project' }); }}
            ...
            <button 
            onClick={(e) => { e.stopPropagation(); addToCompare({ id: props.data["propertyID"], type: 'project' }); }}
