...
import ProjectSearch from '../projects/_components/ProjectSearch';
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl max-w-5xl mx-auto">
                ...
                <div className="flex border-b border-gray-100 ">
                    ...
                    <button
                        ...
                        className={`cursor-pointer flex-1 py-4 text-center font-medium transition-colors relative ${activeTab === 'properties' ? 'text-[#353455] dark:text-white font-bold' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                        {t('Properties')}
                        {activeTab === 'properties' && <div className="absolute bottom-0 left-0 w-full h-1 dark:bg-white bg-[#353455]"></div>}
                    </button>
                </div>
                ...
                <div className="p-6 md:p-8">
                    {activeTab === 'properties' ? (
                        <div className="pt-0">
                            <ProjectSearch isHomeSearch={true} />
                        </div>
                    ) : (
