      ...
      <div id="contact-container" className="container mx-auto max-w-[1200px]">
          ...
          >
            {contactLocations.map((location) => (
              <SwiperSlide key={location.id} className="mx-1 my-1 h-[150px]">
                <div
                  className={`p-2 rounded-lg cursor-pointer flex flex-col items-center justify-center text-center shadow-lg h-full transition-all duration-300 ${
        ...
        <div className="row contact-row mx-0 d-flex align-items-stretch flex-grow-1 mt-8">
          <div className="col-md-6 order-2 md:order-1 space-y-4 d-flex flex-grow-1 align-items-stretch">
            <div className="p-4 border-none rounded bg-white d-flex flex-column">
              <div className="flex flex-wrap gap-4 justify-center mt-8">
                ...
                >
                  <FontAwesomeIcon
                    icon={faPhoneAlt}
                    className="w-5 h-5 mr-2 fa-flip-horizontal text-[#111954] transition-all duration-300 group-hover:text-white"
                  />
                ...
                {selectedOffice.phone2 && (
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faPhoneAlt}
                      className="mr-2 fa-flip-horizontal w-5 h-5 text-[#111954] transition-all duration-300 group-hover:text-white"
                    />
                    {selectedOffice.phone2}
                  </a>
                )}
          ...
          <div className="col-md-6 order-1 md:order-2 space-y-4 d-flex flex-grow-1 align-items-stretch">
