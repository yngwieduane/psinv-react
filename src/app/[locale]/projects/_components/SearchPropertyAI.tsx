...
export default function SearchPropertyAI({ placeholder }: { placeholder: string }) {
        ...
        <div className="hidden lg:block bg-gray-50 border-y border-gray-200 py-5 mb-12">
            <div className="container mx-auto flex flex-wrap gap-6 items-center justify-between">
                <div className="flex gap-3">
                    ...
                    className={`px-5 py-2.5 rounded text-sm font-bold flex items-center gap-2 transition-colors cursor-pointer ${activeTab === 'compare' ? 'bg-primary border border-gray-400' : 'bg-white border border-gray-200 text-gray-600 hover:border-gray-300'}`}
                    >
                ...
                <div className="flex gap-3 text-sm">
                    <select className="px-5 py-2.5 border border-gray-200 rounded bg-white text-gray-700 font-medium focus:outline-none focus:border-secondary cursor-pointer">
