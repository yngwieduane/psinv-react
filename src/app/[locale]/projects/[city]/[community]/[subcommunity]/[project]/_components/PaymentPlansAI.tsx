                ...
                <>
                    ...
                    >
                        {results?.result.map((plan, index) => {
                            ...
                            return (
                                <div key={plan.propertyPaymentPlanId} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                    <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative">
                                        ...
                                        {DP && (
                                            <div className="flex flex-col items-center text-center bg-white z-10 px-4">
                                                <div className="w-16 h-16 rounded-full bg-secondary text-black flex items-center justify-center font-bold text-xl mb-4 border-4 border-orange-100 shadow-lg">
                                                    {DP?.amountPercentage * 100} %
                                                </div>
                                                <h4 className="font-bold text-gray-900 text-lg mb-1">Downpayment</h4>
                                        ...
                                        <div className="flex flex-col items-center text-center bg-white z-10 px-4">
                                            ...
                                            <h4 className="font-bold text-gray-900 text-lg mb-1">During Construction</h4>
                                        ...
                                        {HO && (
                                            <div className="flex flex-col items-center text-center bg-white z-10 px-4">
                                                ...
                                                <h4 className="font-bold text-gray-900 text-lg mb-1">Handover</h4>
