...
export async function generateMetadata(
    ...
    const metatitle = "⚡  "+ unslugify(community)+ " "+unslugify(city)+" Real Estate  - Property Shop Investment" ;
    const metadesc = "⚡  "+ unslugify(community)+ " "+unslugify(city)+" Real Estate  - PSI - Check out our stunning real estate projects - Property Shop Investments - Real Estate Projects - Buy or Rent";
    return {
        title: metatitle,
...
export default async function Projects({
    ...
    return (
        <>
            <ProjectsPage page={currentPage} city={city} cityId={cityId} communityId={communityId} community={community} subcommunity={subcommunity} project={project} propertyname={propertynamefinal} isFeaturedProjectOnWeb={isFeaturedProjectOnWebfinal}/>
        </>
    );
}