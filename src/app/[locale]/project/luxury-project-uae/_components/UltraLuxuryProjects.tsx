...
export default function UltraLuxuryProjects({ onAction }: Props) {
    ...
    return(
        ...
        <div className="max-w-screen-xl mx-auto relative z-10 text-white px-4 ">
            ...
            <UltraLuxuryProjectsSlider data = {UltraLuxuryProjectsData} slides={UltraLuxuryProjectsData} onAction={handlePropDataToSend}  />            
        </div>
        </>
    )
}