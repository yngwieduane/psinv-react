    ...
    return (
        <footer className="bg-[#353B58] text-white w-full mb-0" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="text-center text-[11px] sm:text-base py-4 text-[#000] bg-[#FFF7EC] mb-0">
                <p className="mb-2">
                    <Link title="Privacy" href="/privacy" className="ml-1 cursor-pointer hover:underline">{t('privacy')}</Link> |
                    <Link title="Terms" href="/terms" className="ml-1 cursor-pointer hover:underline">{t('terms')}</Link>
                </p>
                <p>{t('rights')}</p>
            </div>
        </footer>
