    ...
    <section className="w-full">
      ...
      >
        ...
        <div className="relative z-20">
          <h1 className={`text-[64px] md:text-[96px] font-bold ${Audrey.className}`}>CAREERS</h1>
          ...
          >
            ...
            <div className="md:w-7/12 md:pr-8">
              <h2 className="text-2xl md:text-3xl text-[#2C2D65] uppercase mb-4">
                Unlock Your Professional <span className={`${BrittanySignature.className} capitalize  text-orange-600`}>Growth</span>
              </h2>
              <p className={`text-sm md:text-base text-gray-700 leading-relaxed max-w-sm md:max-w-xl ${poppins.className}`}>
                Driven by a passion for excellence, we believe in nurturing talent and fostering career development.
                We offer continuous training programs, insightful workshops, and exclusive industry knowledge to
                ensure our team members excel in their roles.
              </p>
            </div>
...
{isHovered && (
  <div className="w-full flex justify-center">
    <div className="w-full max-w-[1320px] px-4 mt-8 mb-28 z-30"> {/* <-- Increased mb from 16 to 28 */}
    ...
    <section className="w-full bg-secondary-color py-10 text-[var(--color-gray-500)]">
      <div
        ...
        style={{ backgroundImage: "url('/assets/images/about-us/pattern-1.png')" }}
      >
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 gap-6 text-center counter1">
          {/* Counters */}
          <div>
            <h4 className={`text-darkblue font-bold md:text-6xl text-4xl ${Audrey.className}`}>
              <span className="data-count" data-count="150">0</span>K
            </h4>
            <p className={`md:text-lg text-sm font-medium ${montserrat.className}`}>Customers</p>
          </div>
          <div>
            <h4 className={`text-darkblue font-bold md:text-6xl text-4xl ${Audrey.className}`}>
              <span className="data-count" data-count="15">0</span>
            </h4>
            <p className={`md:text-lg text-sm font-medium ${montserrat.className}`}>Languages</p>
          </div>
          <div>
            <h4 className={`text-darkblue font-bold md:text-6xl text-4xl ${Audrey.className}`}>
              +<span className="data-count" data-count="120">0</span>
            </h4>
            <p className={`md:text-lg text-sm font-medium ${montserrat.className}`}>Projects</p>
          </div>
          <div className="hidden md:block">
            <h4 className={`text-darkblue font-bold md:text-6xl text-4xl ${Audrey.className}`}>
              <span className="data-count" data-count="10">0</span>
            </h4>
...
{/* After counters or wherever you want */}
<div className="mt-20">
<JobList />
</div>
